...
static const u1_t PROGMEM DEVEUI[8] = { 0xD8, 0x39, 0x11, 0x00, 0x00, 0xB6, 0x76, 0x98 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from the TTN console can be copied as-is. msb
static const u1_t PROGMEM APPKEY[16] = { 0xE0, 0x5C, 0xF8, 0x34, 0x09, 0x6C, 0xEE, 0xF5, 0x10, 0x38, 0x35, 0xC4, 0x12, 0x8C, 0xFA, 0xEF };
